---
name: "@headlessly/code"
version: 0.1.0
description: Claude Code client SDK for headless.ly — run Claude Code against any GitHub repo via sandboxed containers
license: MIT
repository: "https://github.com/headlessly/headless.ly"
homepage: "https://code.headless.ly"
keywords:
  - headlessly
  - claude-code
  - sandbox
