...
name: db.mw
version: 0.1.0
description: A powerful MDX-based database with JSON-LD and vector search support
license: MIT
repository: "https://github.com/ai-primitives/mdxdb"
homepage: "https://db.mwx.ai"
keywords:
  - mdx
  - database
  - vector-search
...
[![npm version](https://badge.fury.io/js/@mdx.do%2Fdb.svg)](https://www.npmjs.com/package/mdxdb)
...
MIT © [mdxdb](https://npmjs.com/mdxdb)
