---
name: "@dotdo/pglite-repl"
version: 0.2.33
description: A REPL, or terminal, for use in the browser with PGlite, allowing you to have an interactive session with your WASM Postgres in the page.
license: Apache-2.0
