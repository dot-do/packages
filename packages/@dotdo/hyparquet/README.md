---
name: "@dotdo/hyparquet"
version: 1.17.3
description: Parquet file parser for JavaScript (dotdo fork)
license: MIT
repository: "https://github.com/dot-do/hyparquet"
homepage: "https://github.com/dot-do/hyparquet"
keywords:
  - ai
  - data
  - dotdo
...
[![npm](https://img.shields.io/npm/v/@dotdo/hyparquet)](https://www.npmjs.com/package/@dotdo/hyparquet)
[![minzipped](https://img.shields.io/bundlephobia/minzip/@dotdo/hyparquet)](https://www.npmjs.com/package/@dotdo/hyparquet)
[![workflow status](https://github.com/dot-do/hyparquet/actions/workflows/ci.yml/badge.svg)](https://github.com/dot-do/hyparquet/actions)
[![mit license](https://img.shields.io/badge/License-MIT-orange.svg)](https://opensource.org/licenses/MIT)
![coverage](https://img.shields.io/badge/Coverage-96-darkred)
[![dependencies](https://img.shields.io/badge/Dependencies-0-blueviolet)](https://www.npmjs.com/package/@dotdo/hyparquet?activeTab=dependencies)

This is the dotdo fork of hyparquet. Dependency free since 2023!
...
To create parquet files from javascript, check out the [@dotdo/hyparquet-writer](https://github.com/dot-do/hyparquet-writer) package.
