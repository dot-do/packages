...
name: "@mdxui/json"
version: 0.1.0
description: "Structural output for MDXLD documents: JSON, JSON-LD, JSON Schema, MCP tool and OpenAPI schemas. Not a text register (ui-9ml4.2) — a face of its own. Received from mdx.org.ai with history (ui-9ml4.1)."
license: MIT
