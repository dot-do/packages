...
name: "@mdxui/html"
version: 0.1.0
description: "The html face of mdxui: semantic HTML5 components (no classes, just structure) and an MDXLD document → HTML string renderer. Received from mdx.org.ai with history (ui-9ml4.1)."
license: MIT
